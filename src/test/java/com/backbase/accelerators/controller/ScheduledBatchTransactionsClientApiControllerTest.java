...
public class ScheduledBatchTransactionsClientApiControllerTest {

    private ScheduledBatchTransactionsClientApiController scheduledBatchTransactionsClientApiController;
    ...
    @BeforeEach
    public void setUp() {
        scheduledBatchTransactionsClientApiController = new ScheduledBatchTransactionsClientApiController(scheduledBatchTransactionsService);
    }
    ...
    public void getScheduledBatchOrderHistoryTest() {
        ...
        ResponseEntity<List<ScheduledBatchHistoryItem>> result = scheduledBatchTransactionsClientApiController.getScheduledBatchOrderHistory(fromExecutionDate, toExecutionDate, status, accountNumber, createdBy, batchOrderId, from, size);
